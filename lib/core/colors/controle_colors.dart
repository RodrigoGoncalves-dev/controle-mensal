import 'package:controle_mensal/core/extensions/context_extension.dart';
...
class ControleColors extends ThemeExtension<ControleColors> {
...
//*COLORS
  static const Color primaryColor_ = Color(0xffAD4328);
  static const Color tertiaryColor_ = Color(0xffECA8A7);
  ...
  static const Color secondaryColorL_ = Color(0xffECA8A7);

  //?Dark

  static const Color secondaryColorD_ = Color(0xffECA8A7);
...
//*PARAMS
  ...
  static ControleColors light = ControleColors._(
  ...
  static ControleColors dark = ControleColors._(
    primaryColor: primaryColor_,
  ...
  @override
  ControleColors lerp(ControleColors? other, double t) {
    if (other is! ControleColors) return this;
    return ControleColors._(
