...
import 'package:na_regua_package/src/core/extensions/context_extension.dart';
...
class NaReguaColors extends ThemeExtension<NaReguaColors> {
...
//*COLORS
  static const Color primaryColor_ = Color(0xffEB7909);
  static const Color tertiaryColor_ = Color(0xff015B7E);
  ...
  static const Color secondaryColorL_ = Color(0xff8C0404);

  //?Dark

  static const Color secondaryColorD_ = Color(0xff8C0404);
...
//*PARAMS
  ...
  static NaReguaColors light = NaReguaColors._(
  ...
  static NaReguaColors dark = NaReguaColors._(
    primaryColor: primaryColor_,
  ...
  @override
  NaReguaColors lerp(NaReguaColors? other, double t) {
    if (other is! NaReguaColors) return this;
    return NaReguaColors._(
